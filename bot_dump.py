...
# Токен бота
TOKEN = "1962658409:AAHLc_RkrEzwWfniWRFbMkh1tS5mYBSnVbc"
        ...
        try:
            ...
            if id_index != None:
                ...
                if (main_js["names"][id_index]["choose"] != "" and (
                   (message.text == "1" or message.text.lower() == "первый") or
                   (message.text == "2" or message.text.lower() == "второй") or
                    message.text == "0")):
                    
                    bot.send_message(message.from_user.id, "Выбор обновлён")

                if message.text == "1" or message.text.lower() == "первый":
                    _set_choose(main_js, id_index, "choose", "1")
                    bot.send_message(message.from_user.id, "Вы выбрали 1-ый комплекс")
                    
                elif message.text == "2" or message.text.lower() == "второй":
                    _set_choose(main_js, id_index, "choose", "2")
                    bot.send_message(message.from_user.id, "Вы выбрали 2-ой комплекс")
    ...
    def set_default_choose(message):
        try:
            ...
            if id_index != None:
                ...
                if message.text == "1" or message.text.lower() == "первый":
                    _set_choose(main_js, id_index, "default_ch", "1")                 
                    bot.send_message(message.from_user.id, "Значение по умолчанию установлено")
                    
                elif message.text == "2" or message.text.lower() == "второй":
                    _set_choose(main_js, id_index, "default_ch", "2")                   
                    bot.send_message(message.from_user.id, "Значение по умолчанию установлено")
    ...
    def admin_set_choose_part_two(message):
        try:
            ...
            if id_index != None:
                ...
                if message.text == "1" or message.text.lower() == "первый":
                    main_js["names"][id_index]["default_ch"] = "1"
                    change_js(main_js)
                    ...
                    main_js["names"][id_index]["default_ch"] = "2"
                    change_js(main_js)
                    
                    bot.send_message(main_js["names"][id_index]["id"], "Ваш комплекс по умолчанию был изменён администратором, теперь он 2-ой")
                    bot.send_message(message.from_user.id, "Значение по умолчанию установлено")
        ...
        try:
            ...
            if message.from_user.id in main_js["command"]:
                ...
                for index in range(0, len(main_js["names"])):          
                    ...
                    if temp_ch == "1" or temp_ch == "1      (A)":
                        one += 1
                    elif temp_ch == "2" or temp_ch == "2      (A)":
                        two += 1
